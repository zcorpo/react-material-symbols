...
export default function IndeterminateCheckBox({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M282.63-449.37h395.74q13.87 0 23.25-9.46t9.38-23.3q0-13.83-9.38-23.16-9.38-9.34-23.25-9.34H282.63q-13.87 0-23.25 9.46t-9.38 23.3q0 13.83 9.38 23.16 9.38 9.34 23.25 9.34ZM182.15-114.02q-27.6 0-47.86-20.27-20.27-20.26-20.27-47.86v-595.7q0-27.7 20.27-48.03 20.26-20.34 47.86-20.34h595.7q27.7 0 48.03 20.34 20.34 20.33 20.34 48.03v595.7q0 27.6-20.34 47.86-20.33 20.27-48.03 20.27h-595.7Zm0-68.13h595.7v-595.7h-595.7v595.7Zm0-595.7v595.7-595.7Z" />
    </svg>
  )
}
