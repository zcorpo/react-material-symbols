...
export default function RectangleAddFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M142.15-154.02q-27.58 0-47.86-20.27-20.27-20.28-20.27-47.86v-515.7q0-27.58 20.27-47.98 20.28-20.39 47.86-20.39h675.7q27.58 0 47.98 20.39 20.39 20.4 20.39 47.98v515.7q0 27.58-20.39 47.86-20.4 20.27-47.98 20.27h-675.7Zm303.78-291.91v83.3q0 14.42 9.88 24.24 9.87 9.82 24.37 9.82 14.49 0 24.19-9.82 9.7-9.82 9.7-24.24v-83.3h83.3q14.42 0 24.24-9.88 9.82-9.87 9.82-24.37 0-14.49-9.82-24.19-9.82-9.7-24.24-9.7h-83.3v-83.3q0-14.42-9.88-24.24-9.87-9.82-24.37-9.82-14.49 0-24.19 9.82-9.7 9.82-9.7 24.24v83.3h-83.3q-14.42 0-24.24 9.88-9.82 9.87-9.82 24.37 0 14.49 9.82 24.19 9.82 9.7 24.24 9.7h83.3Z" />
    </svg>
  )
}
