...
export default function Filter1Fill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M533.63-684.43v310.93q0 13.26 9.18 22.35 9.17 9.08 22.57 9.08t22.26-9.08q8.86-9.09 8.86-22.35V-713q0-14.42-9.82-24.24-9.82-9.83-24.25-9.83h-80.36q-13.37 0-22.4 9.01-9.04 9.01-9.04 22.34t9.09 22.31q9.08 8.98 22.35 8.98h51.56ZM266.22-198.09q-27.6 0-47.87-20.26-20.26-20.27-20.26-47.87v-555.69q0-27.7 20.26-48.04 20.27-20.33 47.87-20.33h555.69q27.7 0 48.04 20.33 20.33 20.34 20.33 48.04v555.69q0 27.6-20.33 47.87-20.34 20.26-48.04 20.26H266.22ZM138.09-69.72q-27.7 0-48.04-20.33-20.33-20.34-20.33-48.04v-589.76q0-14.42 9.87-24.24 9.87-9.82 24.49-9.82t24.31 9.82q9.7 9.82 9.7 24.24v589.76h589.76q14.42 0 24.24 9.87 9.82 9.88 9.82 24.49 0 14.62-9.82 24.32-9.82 9.69-24.24 9.69H138.09Z" />
    </svg>
  )
}
