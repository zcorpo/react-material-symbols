...
export default function NextWeekFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M142.15-114.02q-27.6 0-47.86-20.27-20.27-20.26-20.27-47.86v-472.83q0-27.7 20.27-48.03 20.26-20.34 47.86-20.34H314.5v-100q0-27.35 20.27-47.74 20.26-20.39 47.86-20.39h194.74q27.6 0 47.86 20.39 20.27 20.39 20.27 47.74v100h172.35q27.7 0 48.03 20.34 20.34 20.33 20.34 48.03v472.83q0 27.6-20.34 47.86-20.33 20.27-48.03 20.27h-675.7Zm240.48-609.33h194.74v-100H382.63v100Zm131.46 304.78L411.04-315.52q-6.47 6.48-6.59 14.84-.12 8.35 6.45 14.95 6.58 6.6 14.96 6.6t15.1-6.48l109.08-108.85q10.2-10.28 10.2-24.15t-10.2-24.06L439.96-552.76q-6.48-6.24-14.84-6.36-8.36-.12-14.96 6.46-6.59 6.57-6.59 14.95 0 8.38 6.47 15.1l104.05 104.04Z" />
    </svg>
  )
}
