...
export default function CallMissedOutgoing({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M777.85-562.15 523.7-308q-10.2 10.2-22.63 14.79-12.44 4.6-25.11 4.6-12.68 0-25.11-4.6-12.44-4.59-22.63-14.79L136.89-599.33q-10.19-10.19-10.19-24.02 0-13.84 9.8-23.87 10.59-10.04 24.73-10.04t24.4 10.19l290.33 290.33 256.91-257.15H560.91q-14.42 0-24.24-9.87-9.82-9.87-9.82-24.49t9.82-24.32q9.82-9.69 24.24-9.69h251q14.43 0 24.37 9.82 9.94 9.82 9.94 24.24v258q0 14.67-9.99 24.49-9.99 9.82-24.49 9.82-14.5 0-24.2-9.82-9.69-9.82-9.69-24.49v-171.95Z" />
    </svg>
  )
}
