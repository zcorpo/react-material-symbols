...
export default function ThumbDownFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M103.83-331.59q-26.35 0-47.36-21.01-21.01-21.01-21.01-47.36v-71q0-11.47 2.74-26.45 2.73-14.98 7.73-26.22L162.89-794.5q9.72-23.15 32.51-39.59 22.8-16.43 48.14-16.43h399.83q28.35 0 48.24 19.83 19.89 19.84 19.89 48.54v423.22q0 12.77-4.96 25.13-4.96 12.35-14.19 21.6L496.83-105.67q-15.92 16.15-37.69 19.99-21.77 3.83-40.92-6.89-18.92-10.47-28.25-30.75-9.34-20.27-4.62-42.14l34.89-166.13H103.83Zm726.22-518.93q23.6 0 40.96 17.38t17.36 40.97v402.28q0 23.59-17.12 40.94-17.12 17.36-40.48 17.36h-.95q-23.6 0-40.96-17.33-17.36-17.34-17.36-40.86v-402.37q0-23.59 17.36-40.98 17.36-17.39 40.96-17.39h.23Z" />
    </svg>
  )
}
