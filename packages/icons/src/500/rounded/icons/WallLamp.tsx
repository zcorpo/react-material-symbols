...
export default function WallLamp({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M122.04-125.76q-9.69-9.82-9.69-24.24v-180q0-14.42 9.87-24.24 9.87-9.83 24.37-9.83 14.5 0 24.19 9.83 9.7 9.82 9.7 24.24v180q0 14.42-9.87 24.24-9.87 9.83-24.37 9.83-14.5 0-24.2-9.83Zm191.18-382.61h413.56l-81.13-270.67h-251.3l-81.13 270.67Zm0 0h413.56-413.56Zm-58.44 302.44q-14.66 0-24.48-9.88-9.82-9.87-9.82-24.37 0-14.49 9.82-24.19 9.82-9.7 24.48-9.7h188.33q18.14 0 30.48-12.34t12.34-30.48V-440H266.72q-17.15 0-27.23-14.17-10.08-14.18-4.6-30.33l101.52-338.8q3.48-11.2 11.91-17.54 8.43-6.33 20.16-6.33h303.28q11.49 0 19.92 6.33 8.43 6.34 11.91 17.54l101.76 338.8q5.24 16.15-4.84 30.33Q790.43-440 773.28-440H554.07v120q0 47.51-33.28 80.79-33.28 33.28-80.79 33.28H254.78Z" />
    </svg>
  )
}
