...
export default function ArrowShapeUp({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M316.89-148.09v-198.56H167.24q-16.15 0-23.49-14.68-7.34-14.67 2.86-27.34l307.28-384.24q10.08-12.68 26.05-12.68t26.41 12.68l307.04 384.24q10.2 12.67 2.86 27.34-7.34 14.68-23.49 14.68H643.11v198.56q0 14.43-9.82 24.25t-24.25 9.82H351.2q-14.67 0-24.49-9.82-9.82-9.82-9.82-24.25Zm68.37-34.06h189.48v-198.33q0-14.67 9.82-24.49 9.82-9.81 24.48-9.81H702L480-694.87 258-414.78h93.2q14.42 0 24.24 9.94 9.82 9.94 9.82 24.36v198.33ZM480-414.78Z" />
    </svg>
  )
}
