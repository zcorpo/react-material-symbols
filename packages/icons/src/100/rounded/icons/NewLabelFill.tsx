...
export default function NewLabelFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M249-175.15q-3-3.15-3-7.85v-109H137q-4.7 0-7.85-3.21-3.15-3.21-3.15-8t3.15-7.79q3.15-3 7.85-3h109v-109q0-4.7 3.21-7.85 3.21-3.15 8-3.15t7.79 3.15q3 3.15 3 7.85v109h109q4.7 0 7.85 3.21 3.15 3.21 3.15 8t-3.15 7.79q-3.15 3-7.85 3H268v109q0 4.7-3.21 7.85-3.21 3.15-8 3.15t-7.79-3.15ZM462-212q10-22 15-44.66 5-22.66 5-46.34 0-93-66-159t-159-66q-33.52 0-65.26 10Q160-508 132-489v-205q0-21.5 16.25-37.75T186-748h408q13.5 0 24.5 4.98 11 4.99 19.5 16.02l165 214q12 14.68 12 32.84Q815-462 803-447L638-233q-8.5 11.03-19 16.02-10.5 4.98-24 4.98H462Z" />
    </svg>
  )
}
