...
export default function Window({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M226-172q-21.75 0-37.87-16.13Q172-204.25 172-226v-508q0-21.75 16.13-37.88Q204.25-788 226-788h508q21.75 0 37.88 16.12Q788-755.75 788-734v508q0 21.75-16.12 37.87Q755.75-172 734-172H226Zm265-297v275h243q14 0 23-9t9-23v-243H491Zm0-22h275v-243q0-14-9-23t-23-9H491v275Zm-22 0v-275H226q-14 0-23 9t-9 23v243h275Zm0 22H194v243q0 14 9 23t23 9h243v-275Z" />
    </svg>
  )
}
