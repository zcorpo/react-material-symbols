...
export default function Straighten({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M186-292q-22.77 0-38.39-15.61Q132-323.23 132-346v-268q0-23 15.61-38.5Q163.23-668 186-668h588q22.78 0 38.39 15.5T828-614v268q0 22.77-15.61 38.39Q796.78-292 774-292H186Zm0-22h588q12 0 22-10t10-22v-268q0-12-10-22t-22-10H657v115q0 4.72-3.19 7.86-3.2 3.14-8 3.14-4.81 0-7.81-3.14t-3-7.86v-115H491v115q0 4.72-3.19 7.86-3.2 3.14-8 3.14-4.81 0-7.81-3.14t-3-7.86v-115H325v115q0 4.72-3.19 7.86-3.2 3.14-8 3.14-4.81 0-7.81-3.14t-3-7.86v-115H186q-12 0-22 10t-10 22v268q0 12 10 22t22 10Zm128-206Zm166 0Zm166 0Zm-166 40Z" />
    </svg>
  )
}
