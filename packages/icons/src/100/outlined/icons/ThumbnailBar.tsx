...
export default function ThumbnailBar({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M186-212q-21.75 0-37.87-16.13Q132-244.25 132-266v-428q0-21.75 16.13-37.88Q164.25-748 186-748h588q21.75 0 37.88 16.12Q828-715.75 828-694v428q0 21.75-16.12 37.87Q795.75-212 774-212H186Zm162-22h426q14 0 23-9t9-23v-428q0-14-9-23t-23-9H348v492Zm-22 0v-492H186q-14 0-23 9t-9 23v428q0 14 9 23t23 9h140Zm-172 0v-492 492Zm172 0h22-22Zm0-492h22-22Z" />
    </svg>
  )
}
