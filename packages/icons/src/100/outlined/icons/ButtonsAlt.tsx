...
export default function ButtonsAlt({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M186-292q-22.77 0-38.39-15.61Q132-323.23 132-346v-268q0-22.78 15.61-38.39Q163.23-668 186-668h588q22.78 0 38.39 15.61T828-614v268q0 22.77-15.61 38.39Q796.78-292 774-292H186Zm0-22h588q14 0 23-9t9-23v-268q0-14-9-23t-23-9H186q-14 0-23 9t-9 23v268q0 14 9 23t23 9Zm119-72h25v-82h81v-25h-81v-81h-25v81h-81v25h81v82Zm-151 72v-332 332Z" />
    </svg>
  )
}
