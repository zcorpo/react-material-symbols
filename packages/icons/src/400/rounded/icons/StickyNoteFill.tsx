...
export default function StickyNoteFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M180-120q-24 0-42-18t-18-42v-600q0-24 18-42t42-18h600q24 0 42 18t18 42v434q0 12-5 23.5T822-303L657-138q-8 8-19.5 13t-23.5 5H180Zm429-60 171-171h-83q-35 0-61.5 26.5T609-263v83ZM501.5-329.5Q510-338 510-351v-228h99q13 0 21.5-8.5T639-609q0-13-8.5-21.5T609-639H351q-13 0-21.5 8.5T321-609q0 13 8.5 21.5T351-579h99v228q0 13 8.5 21.5T480-321q13 0 21.5-8.5Z" />
    </svg>
  )
}
