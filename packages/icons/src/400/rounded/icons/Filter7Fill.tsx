...
export default function Filter7Fill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M595-683 469-376q-5 14 2.5 26t22.5 12q8 0 15.5-4.5T520-355l133-323 2-11v-24q0-13-8.5-21.5T625-743H455q-13 0-21.5 8.5T425-713q0 13 8.5 21.5T455-683h140ZM260-200q-24 0-42-18t-18-42v-560q0-24 18-42t42-18h560q24 0 42 18t18 42v560q0 24-18 42t-42 18H260ZM140-80q-24 0-42-18t-18-42v-590q0-13 8.5-21.5T110-760q13 0 21.5 8.5T140-730v590h590q13 0 21.5 8.5T760-110q0 13-8.5 21.5T730-80H140Z" />
    </svg>
  )
}
