...
export default function BottomAppBar({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M105.87-105.87V-854.7H854.7v748.83H105.87Zm79.22-216v136.78h589.82v-136.78H551.39q-14.56 15.13-32.96 22.57-18.4 7.43-38.59 7.43-20.2 0-38.43-7.43-18.24-7.44-32.8-22.57H185.09ZM501-367.09q9-9 9-21t-9-21q-9-9-21-9t-21 9q-9 9-9 21t9 21q9 9 21 9t21-9Zm-315.91-21h198.69q0-38.82 28.57-67.8 28.56-28.98 67.52-28.98 38.96 0 67.65 28.98 28.7 28.98 28.7 67.8h198.69v-386.82H185.09v386.82Zm0 203h589.82-589.82Z" />
    </svg>
  )
}
