...
export default function Wysiwyg({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M186.22-107q-32.68 0-55.95-23.27Q107-153.54 107-186.22v-587.56q0-32.68 23.27-55.95Q153.54-853 186.22-853h587.56q32.68 0 55.95 23.27Q853-806.46 853-773.78v587.56q0 32.68-23.27 55.95Q806.46-107 773.78-107H186.22ZM180-180h600v-520H180v520Zm130-310q-12.75 0-21.37-8.68-8.63-8.67-8.63-21.5 0-12.82 8.63-21.32 8.62-8.5 21.37-8.5h330q12.75 0 21.38 8.68 8.62 8.67 8.62 21.5 0 12.82-8.62 21.32-8.63 8.5-21.38 8.5H310Zm0 160q-12.75 0-21.37-8.68-8.63-8.67-8.63-21.5 0-12.82 8.63-21.32 8.62-8.5 21.37-8.5h170q12.75 0 21.38 8.68 8.62 8.67 8.62 21.5 0 12.82-8.62 21.32-8.63 8.5-21.38 8.5H310Z" />
    </svg>
  )
}
