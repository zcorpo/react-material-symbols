...
export default function BarcodeReaderFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M210-78q-69 0-110.5-54T75-253l74-279q-35-24-55.5-63T73-680q0-73 51-124.5T249-856h343q53 0 81 44.5t5 92.5l-81 162q-12 24-35 38.5T511-504h-80l-13 51h5q19 1 31 14.5t12 32.5v73q0 20-13.5 33.5T419-286h-47l-26 102q-13 47-50.5 76.5T210-78Zm569-695-23-50 140-64 22 51-139 63Zm117 299-140-63 23-50 139 64-22 49ZM785-653v-55h155v55H785Z" />
    </svg>
  )
}
