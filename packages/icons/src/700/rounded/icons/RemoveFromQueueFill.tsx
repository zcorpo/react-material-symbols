...
export default function RemoveFromQueueFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M350-481h260q20 0 33.5-13.5t13.5-33.41q0-19.91-13.5-34T610-576H350q-20 0-33.5 14.09t-13.5 34q0 19.91 13.5 33.41Q330-481 350-481ZM149-175q-39.05 0-66.53-27.48Q55-229.95 55-269v-502q0-39.46 27.47-67.23Q109.95-866 149-866h662q39.46 0 67.23 27.77Q906-810.46 906-771v502q0 39.05-27.77 66.52Q850.46-175 811-175H644v33q0 20-14.06 33.5T596-95H364q-20 0-33.5-13.5T317-142v-33H149Z" />
    </svg>
  )
}
