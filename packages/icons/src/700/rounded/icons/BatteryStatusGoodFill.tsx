...
export default function BatteryStatusGoodFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="m638-236 107-108q14-14 33.5-14t33.5 14.05q14 14.06 14 33.5Q826-291 812-277L671-136q-14.07 14-33.53 14Q618-122 604-136l-57-57q-14-14-14-33.5t14-33.5q14-13 33.5-13.5T614-260l24 24ZM297-55q-20.75 0-34.37-13.63Q249-82.25 249-102v-692q0-19.75 13.63-33.88Q276.25-842 297-842h86v-16q0-19.75 13.63-33.88Q410.25-906 430-906h100q19.75 0 33.38 14.12Q577-877.75 577-858v16h87q19.75 0 33.38 14.12Q711-813.75 711-794v283q0 12.97-10.43 22.62-10.42 9.66-23.57 8.38-47 1-89.5 19.53-42.5 18.52-75.17 51.16Q479-375 460.5-332.04 442-289.09 442-239q0 36 10.5 68t28.5 59q12 19 2.5 38T454-55H297Z" />
    </svg>
  )
}
