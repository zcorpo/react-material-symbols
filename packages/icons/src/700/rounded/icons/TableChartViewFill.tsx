...
export default function TableChartViewFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M256.09-95.91Q241-111 241-129.5q0-18.5 15-33.5l194-193q28-28 66.5-28t66.5 28l73 73 182-181q14.36-14 33.18-13.5T904-463q14 14 14 32.8 0 18.8-14 33.2L722-216q-27.68 28-66.34 28Q617-188 589-216l-73-73L322-95q-15 14-33.5 13.5t-32.41-14.41ZM149-95q-39 0-66.5-27.47Q55-149.95 55-189v-602q0-39.46 27.47-67.23Q109.95-886 149-886h582q39.46 0 67.23 27.77Q826-830.46 826-791v180q0 20-14.06 33.5T778-564H149v469Z" />
    </svg>
  )
}
