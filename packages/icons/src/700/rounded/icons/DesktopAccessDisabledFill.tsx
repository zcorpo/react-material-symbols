...
export default function DesktopAccessDisabledFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M131-860v101l-94-94q-11-10-10.5-24.5T38-903q11-11 25-11t25 11l768 766q11 11 10.5 25T855-87q-11 11-25.5 11T805-87L665-226H551v100h39q20 0 33.5 13.5T637-79q0 21-13.5 34.5T590-31H370q-20 0-33.5-13.5T323-79q0-20 13.5-33.5T370-126h39v-100H149q-39 0-66.5-27.5T55-320v-451q0-38 26.5-63.5T131-860Zm776 89v487q0 15-9 26.5t-21 16q-12 4.5-26 3T826-251L290-785q-11-10-13-24.5t2.5-26.5q4.5-12 16.5-21t28-9h488q38 0 66.5 28.5T907-771Z" />
    </svg>
  )
}
