...
export default function PhonePausedFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M797-95q-122 0-247-58T319-317Q212-424 153.5-549.5T95-796q0-29 20-49.5t49-20.5h140q31 0 50.5 16.5T381-802l27 110q4 26-1.5 46T385-612l-104 95q22 36 47 68t57 62q33 35 66.5 61t68.5 44l100-101q17-18 38-24t45 0l99 23q31 9 47.5 29t16.5 50v141q0 29-20.5 49T797-95ZM653.5-589Q643-599 643-615v-215q0-15 10.5-25.5T679-866q15 0 25 10.5t10 25.5v215q0 16-10 26t-25 10q-15 0-25.5-10Zm151 0Q794-599 794-615v-215q0-15 10.5-25.5T830-866q15 0 25.5 10.5T866-830v215q0 16-10.5 26T830-579q-15 0-25.5-10Z" />
    </svg>
  )
}
