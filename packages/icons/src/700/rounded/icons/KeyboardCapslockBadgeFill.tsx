...
export default function KeyboardCapslockBadgeFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M320-277h320q16.72 0 28.36-11T680-315.81q0-16.8-11.64-28.5Q656.72-356 640-356H320q-17 0-28 11.69-11 11.7-11 28.5Q281-299 292-288t28 11Zm160-295 116 116q12 12 27.5 12t28.5-12.5q12-11.5 12-27.37 0-15.86-12-28.13L514-651q-14.36-14-34.18-14T446-651L308-512q-12 12-12 27.5t12.5 28.5q11.5 12 27.37 12 15.86 0 28.13-12l116-116ZM189-95q-39.05 0-66.53-27.47Q95-149.95 95-189v-582q0-39.46 27.47-67.23Q149.95-866 189-866h582q39.46 0 67.23 27.77Q866-810.46 866-771v582q0 39.05-27.77 66.53Q810.46-95 771-95H189Z" />
    </svg>
  )
}
