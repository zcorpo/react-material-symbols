...
export default function SnippetFolderFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M149-135q-39.05 0-66.53-27.98Q55-190.95 55-229v-502q0-38.46 27.47-66.73Q109.95-826 149-826h222q18 0 36 8t31 21l43.45 43H811q38.46 0 66.73 27.97Q906-698.05 906-660v431q0 38.05-28.27 66.02Q849.46-135 811-135H149Zm422-229v-161h49l56 56v105H571Zm-51 75h208q9.85 0 16.42-6.68 6.58-6.68 6.58-16.68V-481q0-9-3.5-17t-9.5-15l-73-73q-7-7-14.85-10.5T632-600H520q-10.28 0-17.14 7.08Q496-585.85 496-576v264q0 9.85 7.08 16.42Q510.15-289 520-289Z" />
    </svg>
  )
}
