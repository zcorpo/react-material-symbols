...
export default function CloudAlertFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M253-135q-97 0-166.5-68T17-369q0-84 51-150.5T201-600q24-100 102-162.5T482-825q116 0 198 82.5T770-543v24q75 7 124 60.5T943-327q0 80-56 136t-136 56H253Zm258-186.5q13-12.5 13-31.5 0-18-13-30.5T480-396q-18 0-30.5 12.5T437-353q0 19 12.5 31.5T480-309q18 0 31-12.5Zm0-142q13-12.5 13-31.5v-111q0-19-13-31.5T480-650q-18 0-30.5 12.5T437-606v111q0 19 12.5 31.5T480-451q18 0 31-12.5Z" />
    </svg>
  )
}
