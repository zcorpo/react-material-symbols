...
export default function SubheaderFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M197.69-140q-23.53 0-40.61-17.08T140-197.69v-564.62q0-23.53 17.08-40.61T197.69-820h564.62q23.53 0 40.61 17.08T820-762.31v564.62q0 23.53-17.08 40.61T762.31-140H197.69Zm86.54-453h261.92q16.38 0 27.61-11.3Q585-615.61 585-632.07q0-16.47-11.24-27.74-11.23-11.27-27.61-11.27H284.23q-16.53 0-27.88 11.31Q245-648.47 245-632q0 16.46 11.35 27.73T284.23-593Z" />
    </svg>
  )
}
