...
export default function AddCard({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M175.38-200q-23.05 0-39.22-16.16Q120-232.33 120-255.38v-449.24q0-23.05 16.16-39.22Q152.33-760 175.38-760h609.24q23.05 0 39.22 16.16Q840-727.67 840-704.62v182.85H150.77v266.39q0 9.23 7.69 16.92 7.69 7.69 16.92 7.69h342.85V-200H175.38Zm-24.61-407.69h658.46v-96.93q0-9.23-7.69-16.92-7.69-7.69-16.92-7.69H175.38q-9.23 0-16.92 7.69-7.69 7.69-7.69 16.92v96.93ZM789.23-100v-120h-120v-30.77h120v-120H820v120h120V-220H820v120h-30.77ZM150.77-230.77v-498.46 498.46Z" />
    </svg>
  )
}
