...
export default function DoorSlidingFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M413.12-462.19q8.57-8.58 8.57-19.89 0-11.3-8.57-19.88-8.58-8.58-19.89-8.58t-19.88 8.58q-8.58 8.58-8.58 19.88 0 11.31 8.58 19.89 8.57 8.57 19.88 8.57 11.31 0 19.89-8.57Zm173.76 0q8.58-8.58 8.58-19.89 0-11.3-8.58-19.88-8.57-8.58-19.88-8.58-11.31 0-19.88 8.58-8.58 8.58-8.58 19.88 0 11.31 8.58 19.89 8.57 8.57 19.88 8.57 11.31 0 19.88-8.57ZM180-160v-30.77h42.92v-553.85q0-22.69 15.96-39.03Q254.85-800 278.31-800h189v609.23h26.15V-800h188.23q23.46 0 39.43 16.35 15.96 16.34 15.96 39.03v553.85H780V-160H180Z" />
    </svg>
  )
}
