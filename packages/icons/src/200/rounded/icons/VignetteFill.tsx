...
export default function VignetteFill({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 -960 960 960" {...props}>
      <path d="M175.38-200q-23.05 0-39.22-16.16Q120-232.33 120-255.38v-449.24q0-23.05 16.16-39.22Q152.33-760 175.38-760h609.24q23.05 0 39.22 16.16Q840-727.67 840-704.62v449.24q0 23.05-16.16 39.22Q807.67-200 784.62-200H175.38Zm461.47-181.27q65.84-41.5 65.84-98.73 0-57.23-65.84-98.73-65.85-41.5-156.62-41.5-90.77 0-156.23 41.35-65.46 41.34-65.46 98.88 0 57.54 65.46 98.88 65.46 41.35 156.23 41.35t156.62-41.5Z" />
    </svg>
  )
}
